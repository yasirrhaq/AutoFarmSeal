# Mulai memakai AutoFarmSeal 0.2
...
1. **Ambil gambar game.** Aplikasi mengecil; klik game dalam empat detik. Setelah mengambil gambar, panduan muncul kembali. Alternatifnya, gunakan screenshot yang sudah ada (tanpa bingkai judul atau desktop).
...
Panduan ini tidak mengeklik game. Batal tidak mengganti profil atau menyimpan gambar percobaan. Ukuran gambar yang berbeda ditolak tanpa menghapus pengaturan lama; buat profil baru untuk ukuran game yang berbeda.

## Kedua: cek pada gambar terbaru

Tekan **2. Coba deteksi (tidak menyerang)**. Saat aplikasi mengecil, kembali ke game dalam empat detik. Hasil satu gambar akan muncul otomatis; tidak perlu mengejar jendela pratinjau di atas game. Angka/kotak yang cocok pada gambar contoh sendiri bukan jaminan pada pose atau jarak lain.
...
**Gambar belum diambil:** setelah menekan Ambil gambar, klik game dalam empat detik. Jangan klik aplikasi bot selama pengambilan.
